...
Your response must be a strictly valid JSON object with the following structure:
{
  ...
  "architecture": {
    ...
    "structure": [
      { "section": "Frontend", "paths": ["/path1", "/path2"] },
      { "section": "Backend", "paths": ["/path1", "/path2"] }
    ],
...
5. All fields in the "architecture" object (projectTitle, techStack, schema, apis, structure, scaling) are MANDATORY.
